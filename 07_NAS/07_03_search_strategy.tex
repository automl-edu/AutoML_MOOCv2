...
\begin{frame}{Regularized Evolution~\liturl{Real et al. 2019}{https://arxiv.org/pdf/1802.01548}}
...
\begin{enumerate}
    ...
    \item Black-box optimization methods are widely used due to their strong performance, can be used in joint optimization with other hyperparameters, and allow for easier adaptation to new problems
