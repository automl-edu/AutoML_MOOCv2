...
\begin{frame}{The $t$-Test}
    \begin{itemize}
        ...
        \item Corrected resampled $t$-test \liturl{Nadeau \& Bengio 2003}{https://link.springer.com/article/10.1023/A:1024068626366}: Adjusts for the dependency of MCCV folds to avoid inflated type-I error
    \end{itemize}
\end{frame}
...
\begin{frame}{Post-Hoc Tests and Corrections}
    ...
    \resizebox{\textwidth}{!}{
        \input{02_Evaluation/images/critical_diff_plot}}
    \end{minipage}
\end{frame}
...
\begin{itemize}
    \item Using an uncorrected $t$-test on MCCV folds (inflated type-I error)
