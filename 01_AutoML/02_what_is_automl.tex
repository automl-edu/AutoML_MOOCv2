...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{\alert{Automated} Machine Learning}

\begin{center}
Automated Machine Learning (AutoML) supports the development process of new machine learning applications by striving to make modeling and implementation decisions automatically.
\end{center}
...
With respect to the development of new ML applications, AutoML improves...

\begin{itemize}
    \item[\emoji{rocket}] \textbf{Efficiency \& Effectiveness} -- AutoML has been shown to outperform humans in ML and DS competitions!
...
\begin{itemize}
    ...
    \begin{itemize}
       ...
       %\item Local Search: local greedy improvement  (in the direction of the largest improvement)
        \item Bayesian Optimization: Trade-off between exploration and exploitation
        \item ...
    \end{itemize}
    \item This is in contrast to human bias, which could lead to suboptimal decisions (e.g., ``I have learned about Transformers, so I'm trying only Transformers'')
\end{itemize}
