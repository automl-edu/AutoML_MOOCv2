...
\begin{itemize}
    \item Rather than returning a model, sometimes we are rather interested in the optimized configuration of the model or the entire pipeline
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item For example, domain experts may prefer a very basic interface with dataset as input and a model as an output
