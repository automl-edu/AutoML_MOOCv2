...
%-----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{2025 Foundation Models as One Future of AutoML}

\begin{columns}

\column{0.4\textwidth}

\includegraphics[width=1.0\textwidth]{images/tabpfn_nature.png}

\column{0.6\textwidth}

\begin{itemize}
    \item (Tabular) Foundation allow to use of machine learning out of the box, without any
    \begin{itemize}
        \item Training
        \item Hyperparameter optimization
    \end{itemize}
    \item Pre-trained large-scale model that allows in-context-learning on entire (tabular) datasets to get predictions
    \item The dream of AutoML by having a simple ``load and predict'' action, allowing frictionless execution
\end{itemize}
...
\begin{itemize}
    ...
    \item Many AutoML packages (AutoGluon and Optuna probably the most famous ones as of early 2026), see \url{https://automl.space}
