...
\textbf{Advanced Case:} We have prior observations on \textit{related} datasets (e.g., from HPO on a different dataset)

\vspace{0.5cm}
$\leadsto$ We can inject knowledge into the selection of the next configuration to evaluate in the early stages of Bayesian Optimization.
...
%-----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}{Simple Case: Prior Observations from Manual Exploration}
...
\textbf{$\leadsto$ How do we define task similarity?} \\
\pause
$\leadsto$ Configurations achieve similar performance on similar datasets, i.e., if the datasets are similar, good configurations transfer.
