...
%\begin{itemize}
    ...
    \end{columns}
    \onslide<4->{
    I.e.: We do not take into account what happens inside the box!}
...
\begin{itemize}
    \item \textbf{Learning is an Iterative Process:} During learning, we traverse a diverse solution landscape. This traversal requires adaptation to the hyperparameters.
    \pause
