...
\begin{frame}{Population-Based Training (PBT) \liturl{Jaderberg et al. 2017}{https://arxiv.org/abs/1711.09846}}
        ...
        Exploit: Copy over well performing weights -- Explore: Perturbe Hyperparameters
\end{frame}
%-----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}{Population-Based Training (PBT) - Cont'd \liturl{Jaderberg et al. 2017}{https://arxiv.org/abs/1711.09846}}
        \centering
...
\begin{frame}{Properties of PBT}
    \begin{itemize}
        \item PBT does not return a hyperparameter optimization policy\pause
...
\begin{frame}{Combining PBT and Bayesian Optimization}
    \begin{itemize}
        ...
        \item Can BO guide exploration?\pause \
        ...
        \begin{itemize}
            \item PBT can run asynchronously \rightarrow force synchronicity or use approaches for parallel BO\pause
            \item Cost of $\cost(\conf^{(t)})$ depends on the previous $\conf^{(t-1)}, \conf^{(t-2)}, \ldots, \conf^{(1)}$
            \begin{itemize}
...
%-----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}{Meta Population Based Bandits \liturl{Hog et al. 2025}{https://proceedings.mlr.press/v188/wan22a.html}}
        \centering
...
\begin{itemize}
    ...
    \item \textbf{Successors incorporate prior knowledge in various ways:} PB2 builds a surrogate based on previous performance, BG-PBT uses distillation to transfer performance across architecture generations, Meta-PB2 uses meta-learning techniques for BO to incorporate more knowledge of prior tuning experiments.
    \item \textbf{PBT-style HPO does ont produce usable schedules.}
\end{itemize}
