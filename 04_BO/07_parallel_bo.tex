...
\begin{frame}[t]{Why Parallel BO?}
  \begin{itemize}
    ...
    \item Still attractive to generate a \textbf{batch} of $q > 1$ points to evaluate \emph{simultaneously}
...
\begin{frame}[t]{Joint / $q$-Acquisition Functions}
  ...
  \begin{itemize}
    ...
    trick (BoTorch): draw MC base noise $\xi\!\sim\!\mathcal{N}(0,I)$ \emph{once} and reuse across steps
