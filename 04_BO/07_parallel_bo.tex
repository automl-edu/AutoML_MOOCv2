...
\begin{frame}[t]{Why Parallel BO?}
  \begin{itemize}
    ...
    \item We can try to fully parallelize the underlying function evaluations,
    ...
    \item But remember: random search sometimes hard to beat (in particular in the parallel setting)
  \end{itemize}
\end{frame}
...
\begin{frame}[t]{Heuristic 1: Kriging Believer / Fantasizing~\liturl{Ginsbourger et al. 2010}{https://link.springer.com/chapter/10.1007/978-3-642-10701-6_6}}
  ...
  \begin{enumerate}\setlength\itemsep{0pt}
    ...
    \item \textbf{Fantasize} the outcome at $\confI{1}$: replace the unknown $\cost(\confI{1})$ with
        ...
        \end{itemize}
    \item Refit and propose $\confI{2} \in \argmax \acq(\conf)$; repeat until $q$ points assembled
  \end{enumerate}
