...
\begin{frame}[t]{The Core Challenge}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.55\textwidth]{images/07_batch_bo_naive_vs_diverse.pdf}\\
...
\begin{frame}[t]{Heuristic 1: Kriging Believer / Fantasizing~\liturl{Ginsbourger et al. 2010}{https://link.springer.com/chapter/10.1007/978-3-642-10701-6_6}}
  ...
  \begin{center}
    \includegraphics[width=0.55\textwidth]{images/07_batch_bo_kriging_believer.pdf}\\
