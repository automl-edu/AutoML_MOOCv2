...
\begin{frame}[t]{Noisy Evaluations}
  ...
  \vfill
  \begin{center}
    \includegraphics[width=.45\textwidth]{images/noisy_0.png}
  \end{center}
\end{frame}
...
\begin{frame}[t]{Noise-Aware Surrogate: Nugget GP}
  \begin{columns}[onlytextwidth,T]
    ...
    \begin{itemize}
      ...
      \item $\noisevar$ learned via type-II ML alongside the kernel HPs
    \end{itemize}
    \column{.45\textwidth}
    \begin{center}
...
\begin{frame}[t]{Which Point to Return?}
  ...
  \vfill
  \begin{center}
    \includegraphics[width=.4\textwidth]{images/noisy_5.png}
  \end{center}
\end{frame}
