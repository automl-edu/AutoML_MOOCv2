...
%   \column{.62\textwidth}
  ...
  \end{itemize}
  % \column{.38\textwidth}
  \includegraphics[width=0.5\textwidth]{images/bayesian_loop_lcb_0_obj.pdf}\\
  \includegraphics[width=0.5\textwidth]{images/bayesian_loop_lcb_0_acq.pdf}
% \end{columns}
\end{frame}
...
\begin{frame}[t]{Expected Improvement}
  ...
  \vfill
  \begin{center}
    \includegraphics[width=.7\textwidth]{images/bayesian_loop_6_obj.pdf}\\
    \includegraphics[width=.7\textwidth]{images/bayesian_loop_6_acq.pdf}
  \end{center}
\end{frame}
