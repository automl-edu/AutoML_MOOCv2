...
ggsave(file.path("../images/noisy_0.png"), plot = g, width = 5, height = 4)
...
ggsave(file.path("../images/noisy_2.png"), plot = g_noisy, width = 5, height = 4)
...
ggsave(file.path("../images/noisy_3.png"), plot = g / aei, width = 5, height = 4)
...
ggsave(file.path("../images/noisy_4.png"), plot = g / ei, width = 5, height = 4)
...
ggsave(file.path("../images/noisy_5.png"), plot = g, width = 5, height = 4)
