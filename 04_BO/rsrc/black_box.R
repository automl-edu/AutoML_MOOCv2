...
ggsave("../images/black_box_0.png", plot = g, width = 5, height = 4)
...
ggsave("../images/black_box_1.png", plot = g, width = 5, height = 4)
...
ggsave("../images/black_box_2.png", plot = g, width = 5, height = 4)
