...
ggsave("../images/bayesian_loop_ee.png", plot = g, width = 5, height = 4)
...
ggsave("../images/bayesian_loop_sm.png", plot = g, width = 5, height = 4)
...
ggsave("../images/bayesian_loop_sm_fmin.png", plot = g, width = 5, height = 4)
...
ggsave("../images/bayesian_loop_sm_normal.png", plot = g, width = 5, height = 4)
...
ggsave("../images/bayesian_loop_sm_normal_fmin.png", plot = g, width = 5, height = 4)
...
ggsave("../images/bayesian_loop_1.png", plot = g / ei, width = 5, height = 4)
...
for (i in 2:6) {
  ...
  ggsave(sprintf("../images/bayesian_loop_%i.png", i), plot = g / ei, width = 5, height = 4)
