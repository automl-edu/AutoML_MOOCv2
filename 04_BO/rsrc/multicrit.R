...
ggsave("../images/multicrit_0.png", plot = g, width = 5, height = 4)
...
ggsave("../images/multicrit_1.png", plot = g, width = 5, height = 4)
...
ggsave("../images/multicrit_2.png", plot = g, width = 5, height = 4)
...
ggsave("../images/multicrit_3.png", plot = g + (scal / ei), width = 10, height = 4)
...
for (i in 4:4) {
  ...
  ggsave(file.path(sprintf("../images/multicrit_%i.png", i)), plot = g + (scal / ei), width = 10, height = 4)
