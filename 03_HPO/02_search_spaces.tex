...
\begin{frame}{Introduction}
    \begin{itemize}
        ...
        \item They can depend on one another
...
\begin{frame}{Hyperparameter Ranges}
    ...
    \end{itemize}
    $\leadsto$ should be carefully determined, e.g.\ it makes little sense to allow 1,000,000 trees in a random forest
\end{frame}
...
\begin{frame}{Hyperparameter Dependencies}
    ...
    \end{itemize}
    $\leadsto$ specifying all dependencies can be very complex, invalid configurations must be handled appropriately
\end{frame}
